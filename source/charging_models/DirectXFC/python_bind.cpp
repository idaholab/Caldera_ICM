...
PYBIND11_MODULE(Caldera_global, m)
{
    ...
    py::enum_<vehicle_enum>(m, "vehicle_enum")
		.value("phev20", vehicle_enum::phev20)
		.value("phev50", vehicle_enum::phev50)
        .value("phev_SUV", vehicle_enum::phev_SUV)
		.value("bev150_ld1_50kW", vehicle_enum::bev150_ld1_50kW)
		.value("bev250_ld1_75kW", vehicle_enum::bev250_ld1_75kW)
		.value("bev275_ld1_150kW", vehicle_enum::bev275_ld1_150kW)
		.value("bev200_ld4_150kW", vehicle_enum::bev200_ld4_150kW)
		.value("bev250_ld2_300kW", vehicle_enum::bev250_ld2_300kW)        
        .value("bev250_400kW", vehicle_enum::bev250_400kW)
        .value("bev300_575kW", vehicle_enum::bev300_575kW)
        .value("bev300_400kW", vehicle_enum::bev300_400kW)
        .value("bev250_350kW", vehicle_enum::bev250_350kW)
        .value("bev300_300kW", vehicle_enum::bev300_300kW)
        .value("bev150_150kW", vehicle_enum::bev150_150kW);
    
    py::enum_<supply_equipment_enum>(m, "supply_equipment_enum")
		.value("L1_1440", supply_equipment_enum::L1_1440)
		.value("L2_3600", supply_equipment_enum::L2_3600)
        .value("L2_7200", supply_equipment_enum::L2_7200)
		.value("L2_9600", supply_equipment_enum::L2_9600)
		.value("L2_11520", supply_equipment_enum::L2_11520)
		.value("L2_17280", supply_equipment_enum::L2_17280)
		.value("dcfc_50", supply_equipment_enum::dcfc_50)
