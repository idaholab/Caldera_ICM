...
PYBIND11_MODULE(Caldera_global, m)
{
    ...
    py::enum_<supply_equipment_enum>(m, "supply_equipment_enum")
        .value("L2_7200W", supply_equipment_enum::L2_7200W)
        .value("L2_17280W", supply_equipment_enum::L2_17280W)
        .value("xfc_20kW", supply_equipment_enum::xfc_20kW)
        .value("xfc_50kW", supply_equipment_enum::xfc_50kW)
		.value("xfc_90kW", supply_equipment_enum::xfc_90kW)
        .value("xfc_150kW", supply_equipment_enum::xfc_150kW)
		.value("xfc_180kW", supply_equipment_enum::xfc_180kW)
        .value("xfc_450kW", supply_equipment_enum::xfc_450kW);
