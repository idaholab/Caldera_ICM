...
PYBIND11_MODULE(Caldera_global, m)
{
    //---------------------------------
    //          Functions
    //---------------------------------
    m.def("get_supply_equipment_enum", &get_supply_equipment_enum);
    m.def("get_vehicle_enum", &get_vehicle_enum);
    m.def("supply_equipment_is_L1", &supply_equipment_is_L1);
    m.def("supply_equipment_is_L2", &supply_equipment_is_L2);
    m.def("supply_equipment_is_50kW_dcfc", &supply_equipment_is_50kW_dcfc);
    m.def("supply_equipment_is_3phase", &supply_equipment_is_3phase);
    m.def("is_XFC_charge", &is_XFC_charge);
    m.def("pev_is_compatible_with_supply_equipment", &pev_is_compatible_with_supply_equipment);
    m.def("get_all_SE_enums", &get_all_SE_enums);
    m.def("get_all_pev_enums", &get_all_pev_enums);
    m.def("get_all_compatible_pev_SE_combinations", &get_all_compatible_pev_SE_combinations);
    m.def("get_default_supply_equipment_enum", &get_default_supply_equipment_enum);
    m.def("get_default_vehicle_enum", &get_default_vehicle_enum);
    ...
    //        PEV and SE Enums
    //---------------------------------
    py::enum_<vehicle_enum>(m, "vehicle_enum")
		.value("ld_50kWh", vehicle_enum::ld_50kWh)
		.value("ld_100kWh", vehicle_enum::ld_100kWh)
        .value("md_200kWh", vehicle_enum::md_200kWh)
		.value("hd_300kWh", vehicle_enum::hd_300kWh)
		.value("hd_400kWh", vehicle_enum::hd_400kWh)
		.value("hd_600kWh", vehicle_enum::hd_600kWh)
		.value("hd_800kWh", vehicle_enum::hd_800kWh)
		.value("hd_1000kWh", vehicle_enum::hd_1000kWh);
    
    py::enum_<supply_equipment_enum>(m, "supply_equipment_enum")
        .value("L2_7200", supply_equipment_enum::L2_7200)
        .value("L2_17280", supply_equipment_enum::L2_17280)
        .value("xfc_150", supply_equipment_enum::xfc_150)
        .value("xfc_350", supply_equipment_enum::xfc_350)
		.value("xfc_500kW", supply_equipment_enum::xfc_500kW)
		.value("xfc_1000kW", supply_equipment_enum::xfc_1000kW)
        .value("xfc_2000kW", supply_equipment_enum::xfc_2000kW)
		.value("xfc_3000kW", supply_equipment_enum::xfc_3000kW)
        .value("dwc_100kW", supply_equipment_enum::dwc_100kW);
    ...
    py::class_<pev_SE_pair>(m, "pev_SE_pair")
        ...
        .def(py::pickle(
            [](const pev_SE_pair &obj){  // __getstate__
                return py::make_tuple(obj.EV_type, obj.SE_type);
            },
            [](py::tuple t){  // __setstate__
                pev_SE_pair obj;
                obj.EV_type = t[0].cast<vehicle_enum>();
                obj.SE_type = t[1].cast<supply_equipment_enum>();
                return obj;
            }
        ));
    ...
    py::class_<stop_charging_criteria>(m, "stop_charging_criteria")
        ...
        .def(py::pickle(
            [](const stop_charging_criteria &obj){  // __getstate__
    ...
    py::class_<charge_event_data>(m, "charge_event_data")
        .def(py::init<>())
        .def(py::init<int, int, SE_id_type, vehicle_id_type, vehicle_enum, double, double, double, double, stop_charging_criteria, control_strategy_enums>())
        ...
        .def(py::pickle(
            [](const charge_event_data &obj){  // __getstate__
            ...
            [](py::tuple t){  // __setstate__
                ...
                obj.vehicle_type = t[4].cast<vehicle_enum>();
    ...
    py::class_<SE_group_charge_event_data>(m, "SE_group_charge_event_data")
        ...
        .def(py::pickle(
            [](const SE_group_charge_event_data &obj){  // __getstate__
    ...
    py::class_<SE_configuration>(m, "SE_configuration")
        .def(py::init<>())
        .def(py::init<int, SE_id_type, supply_equipment_enum, double, double, grid_node_id_type, std::string>())
        ...
        .def(py::pickle(
            [](const SE_configuration &obj){  // __getstate__
            ...
            [](py::tuple t){  // __setstate__
                ...
                obj.supply_equipment_type = t[2].cast<supply_equipment_enum>();
    ...
    py::class_<SE_group_configuration>(m, "SE_group_configuration")
        ...
        .def(py::pickle(
            [](const SE_group_configuration &obj){  // __getstate__
    ...
    py::class_<FICE_inputs>(m, "FICE_inputs")
        ...
        .def(py::pickle(
            [](const FICE_inputs &obj){  // __getstate__
     ...
     py::class_<CE_FICE>(m, "CE_FICE")
        ...
        .def(py::pickle(
            [](const CE_FICE &obj){  // __getstate__
    ...
    py::class_<CE_FICE_in_SE_group>(m, "CE_FICE_in_SE_group")
        ...
        .def(py::pickle(
            [](const CE_FICE_in_SE_group &obj){  // __getstate__
    ...
    py::class_<active_CE>(m, "active_CE")
        ...
        .def(py::pickle(
            [](const active_CE &obj){  // __getstate__
            ...
            [](py::tuple t){  // __setstate_
                ...
                obj.vehicle_type = t[10].cast<vehicle_enum>();
    ...
    py::class_<SE_setpoint>(m, "SE_setpoint")
        ...
        .def(py::pickle(
            [](const SE_setpoint &obj){  // __getstate__
    ...
    py::class_<completed_CE>(m, "completed_CE")
        ...
        .def(py::pickle(
            [](const completed_CE &obj){  // __getstate__
    ...
    py::class_<SE_power>(m, "SE_power")
        ...
        .def(py::pickle(
            [](const SE_power &obj){  // __getstate__
    ...
    py::class_<pev_batterySize_info>(m, "pev_batterySize_info")
        ...
        .def(py::pickle(
            [](const pev_batterySize_info &obj){  // __getstate__
            ...
            [](py::tuple t){  // __setstate__
                ...
                obj.vehicle_type = t[0].cast<vehicle_enum>();
    ...
    py::class_<pev_charge_profile_result>(m, "pev_charge_profile_result")
        ...
        .def(py::pickle(
            [](const pev_charge_profile_result &obj){  // __getstate__
    ...
    py::class_<pev_charge_fragment_removal_criteria>(m, "pev_charge_fragment_removal_criteria")
        ...
        .def(py::pickle(
            [](const pev_charge_fragment_removal_criteria &obj){  // __getstate__
    ...
    py::class_<pev_charge_fragment>(m, "pev_charge_fragment")
        ...
        .def(py::pickle(
            [](const pev_charge_fragment &obj){  // __getstate__
    ...
    py::class_<pev_charge_fragment_variation>(m, "pev_charge_fragment_variation")
        ...
        .def(py::pickle(
            [](const pev_charge_fragment_variation &obj){  // __getstate__
    ...
    py::class_<charge_profile_validation_data>(m, "charge_profile_validation_data")
        ...
        .def(py::pickle(
            [](const charge_profile_validation_data &obj){  // __getstate__
    ...
    py::class_<charge_event_P3kW_limits>(m, "charge_event_P3kW_limits")
        ...
        .def(py::pickle(
            [](const charge_event_P3kW_limits &obj){  // __getstate__
    ...
    py::class_<all_charge_profile_data>(m, "all_charge_profile_data")
        ...
        .def(py::pickle(
            [](const all_charge_profile_data &obj){  // __getstate__
                return py::make_tuple(obj.timestep_sec, obj.P1_kW, obj.P2_kW, obj.P3_kW, obj.Q3_kVAR, obj.soc);
            },
            [](py::tuple t){  // __setstate__
                all_charge_profile_data obj;
                obj.timestep_sec = t[0].cast<double>();
                
                for(auto x : t[1])
                    obj.P1_kW.push_back(x.cast<double>());
                
                for(auto x : t[2])
                    obj.P2_kW.push_back(x.cast<double>());
                
                for(auto x : t[3])
                    obj.P3_kW.push_back(x.cast<double>());
                
                for(auto x : t[4])
                    obj.Q3_kVAR.push_back(x.cast<double>());
                
                for(auto x : t[5])
                    obj.soc.push_back(x.cast<double>());
    ...
    py::class_<LPF_parameters>(m, "LPF_parameters")
        ...
        .def(py::pickle(
            [](const LPF_parameters &obj){  // __getstate__
    ...
    py::class_<LPF_parameters_randomize_window_size>(m, "LPF_parameters_randomize_window_size")
        ...
        .def(py::pickle(
            [](const LPF_parameters_randomize_window_size &obj){  // __getstate__
    ...
    py::class_<ES100_L2_parameters>(m, "ES100_L2_parameters")
        ...
        .def(py::pickle(
            [](const ES100_L2_parameters &obj){  // __getstate__
    ...
    py::class_<ES110_L2_parameters>(m, "ES110_L2_parameters")
        ...
        .def(py::pickle(
            [](const ES110_L2_parameters &obj){  // __getstate__
    ...
    py::class_<ES200_L2_parameters>(m, "ES200_L2_parameters")
        ...
        .def(py::pickle(
            [](const ES200_L2_parameters &obj){  // __getstate__
    ...
    py::class_<ES300_L2_parameters>(m, "ES300_L2_parameters")
        ...
        .def(py::pickle(
            [](const ES300_L2_parameters &obj){  // __getstate__
                return py::make_tuple(obj.weight_factor_to_calculate_valley_fill_target);
            },
            [](py::tuple t){  // __setstate__
    ...
    py::class_<normal_random_error>(m, "normal_random_error")
        ...
        .def(py::pickle(
            [](const normal_random_error &obj){  // __getstate__
    ...
    py::class_<ES500_L2_parameters>(m, "ES500_L2_parameters")
        ...
        .def(py::pickle(
            [](const ES500_L2_parameters &obj){  // __getstate__
    ...
    py::class_<VS100_L2_parameters>(m, "VS100_L2_parameters")
        ...
        .def(py::pickle(
            [](const VS100_L2_parameters &obj){  // __getstate__
    ...
    py::class_<VS200_L2_parameters>(m, "VS200_L2_parameters")
        ...
        .def(py::pickle(
            [](const VS200_L2_parameters &obj){  // __getstate__
    ...
    py::class_<VS300_L2_parameters>(m, "VS300_L2_parameters")
        ...
        .def(py::pickle(
            [](const VS300_L2_parameters &obj){  // __getstate__
    ...
    py::class_<control_strategy_enums>(m, "control_strategy_enums")
        ...
        .def(py::pickle(
            [](const control_strategy_enums &obj){  // __getstate__
    ...
    py::class_<L2_control_strategy_parameters>(m, "L2_control_strategy_parameters")
        ...
        .def(py::pickle(
            [](const L2_control_strategy_parameters &obj){  // __getstate__
    ...
    py::class_<ES500_aggregator_pev_charge_needs>(m, "ES500_aggregator_pev_charge_needs")
        ...
        .def(py::pickle(
            [](const ES500_aggregator_pev_charge_needs &obj){  // __getstate__
    ...
    py::class_<ES500_aggregator_charging_needs>(m, "ES500_aggregator_charging_needs")
        ...
        .def(py::pickle(
            [](const ES500_aggregator_charging_needs &obj){  // __getstate__
    ...
    py::class_<ES500_aggregator_e_step_setpoints>(m, "ES500_aggregator_e_step_setpoints")
        ...
        .def(py::pickle(
            [](const ES500_aggregator_e_step_setpoints &obj){  // __getstate__
    ...
    py::class_<ES500_aggregator_charging_forecast>(m, "ES500_aggregator_charging_forecast")
        ...
        .def(py::pickle(
            [](const ES500_aggregator_charging_forecast &obj){  // __getstate__
    ...
    py::class_<ES500_aggregator_obj_fun_constraints>(m, "ES500_aggregator_obj_fun_constraints")
        ...
        .def(py::pickle(
            [](const ES500_aggregator_obj_fun_constraints &obj){  // __getstate__
    ...
    py::class_<ES500_charge_cycling_control_boundary_point>(m, "ES500_charge_cycling_control_boundary_point")
        ...
        .def(py::pickle(
            [](const ES500_charge_cycling_control_boundary_point &obj){  // __getstate__
    ...
    py::class_<ES500_stop_charge_cycling_decision_parameters>(m, "ES500_stop_charge_cycling_decision_parameters")
        ...
        .def(py::pickle(
            [](const ES500_stop_charge_cycling_decision_parameters &obj){  // __getstate__
    ...
    py::class_<pev_charge_ramping>(m, "pev_charge_ramping")
        ...
        .def(py::pickle(
            [](const pev_charge_ramping &obj){  // __getstate__
    ...
    py::class_<pev_charge_ramping_workaround>(m, "pev_charge_ramping_workaround")
        ...
        .def(py::pickle(
            [](const pev_charge_ramping_workaround &obj){  // __getstate__
            ...
            [](py::tuple t){  // __setstate__
                ...
                obj.pev_type = t[1].cast<vehicle_enum>();
                obj.SE_type = t[2].cast<supply_equipment_enum>();                
                return obj;
            }
        ));
}
