...
void transition_of_X_through_time::init_transition(double start_of_transition_unix_time, double X_at_beginning_of_transition_, double target_ref_X_, transition_interruption_state trans_interruption_state, bool transition_just_crossed_zero)
{
...
transition_integral_of_X transition_of_X_through_time::get_integral(double target_X, double integrate_to_unix_time, bool transition_will_cross_zero)
{
	bool will_reach_target_before_now_time, target_X_deviation_limit_exceeded, current_X_passed_target_cuz_target_X_moved;
	bool transition_complete_cuz_target_X_moved, from_final_complete_cuz_target_X_moved;
	bool in_this_segment_will_reach_target, in_this_segment_will_reach_now_unix_time;
	
	double now_X_val, start_of_interval_X_val, end_of_interval_X_val, end_of_segment_X_val;
	double start_of_interval_unix_time, end_of_interval_unix_time_aux, end_of_segment_unix_time;
	double criteria_value, interval_area_Xsec, interval_duration_sec, segment_slope_;
...
integrate_X_through_time::integrate_X_through_time(double target_deadband_, double off_deadband_, bool pos_and_neg_transitions_are_unique_,
...
bool integrate_X_through_time::transition_moving_toward_pos_inf(transition_state trans_state_)
{
...
integral_of_X integrate_X_through_time::get_next(double target_X, double integrate_from_unix_time, double integrate_to_unix_time)
{
    // Allowed Transitions
    //     off,
    //     on_steady_state,
