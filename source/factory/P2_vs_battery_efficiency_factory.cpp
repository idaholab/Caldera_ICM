...
P2_vs_battery_efficiency::P2_vs_battery_efficiency(const line_segment& curve, const double& zero_slope_threashold) 
...
P2_vs_battery_efficiency_factory::P2_vs_battery_efficiency_factory(const EV_EVSE_inventory& inventory) : inventory(inventory), P2_vs_battery_eff(this->load_P2_vs_battery_eff()) {}
...
{    
    ...
    return std::move(outer_map);
}

const P2_vs_battery_efficiency& P2_vs_battery_efficiency_factory::get_P2_vs_battery_eff(const EV_type& EV, const battery_charge_mode& mode) const
{
