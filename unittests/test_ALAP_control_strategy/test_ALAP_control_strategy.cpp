                         ...
                         const std::string& control_strategy)
{
    ...
    correct_solution_data[ node_ids_strings_arr.at(0) ] = std::make_tuple( 12.55, 13.01666667, 11.5 );
    correct_solution_data[ node_ids_strings_arr.at(1) ] = std::make_tuple( 17.55, 18.0166666667, 11.5 );
    correct_solution_data[ node_ids_strings_arr.at(2) ] = std::make_tuple( 15.05,       15.51666667, 11.5 );
    correct_solution_data[ node_ids_strings_arr.at(3) ] = std::make_tuple( 17.55, 18.0166666667,        11.5 );
    ...
    correct_solution_data[ node_ids_strings_arr.at(7) ] = std::make_tuple(  10.35, 17.8, 11.5 );
    correct_solution_data[ node_ids_strings_arr.at(8) ] = std::make_tuple( 17.55, 18.0166666667,        11.5 );
    correct_solution_data[ node_ids_strings_arr.at(9) ] = std::make_tuple( 10.05,  10.5166666667,        11.5 );
